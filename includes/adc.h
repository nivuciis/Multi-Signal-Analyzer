 ...
 * 
 * @param rsp[out] Pointer to store the ADC reading result.
 ...
 * 
 * @param rsp1[out] Pointer to store the ADC reading result for channel 1.
 * @param rsp2[out] Pointer to store the ADC reading result for channel 2.
 * @param rsp3[out] Pointer to store the ADC reading result for channel 3.
